"object" == typeof navigator && function () {
    ...
    !function (e) {
        ...
        (function () {
            ...
            var r = function (e) {
                ...
                var t = typeof e;
                if ("undefined" === t) ; else if ("string" === t) "" !== e && this._fromString(e); else if (e instanceof r) {
                    var n = this;
                    ...
                    if ("[object Array]" === Object.prototype.toString.call(e)) for (var i = 0; i < e.length; i++) {
                        var s = e[i];
  ...
  ***************************************************************************** */
    ...
    function h(e, t, n) {
        var i = n || u(), r = i.__SENTRY__ = i.__SENTRY__ || {};
        return r[e] || (r[e] = t())
    }
    ...
    var x = function (e) {
            function t(t) {
                var n = this.constructor, i = e.call(this, t) || this;
                return i.message = t, i.name = n.prototype.constructor.name, S(i, n.prototype), i
            }

            return n(t, e), t
        }(Error), C = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__,
        A = /^(?:(\w+):)\/\/(?:(\w+)(?::(\w+))?@)([\w.-]+)(?::(\d+))?\/(.+)/;

    function P(e, t) {
        void 0 === t && (t = !1);
        var n = e.host, i = e.path, r = e.pass, s = e.port, o = e.projectId;
    ...
    function N(e) {
        var t = "string" == typeof e ? function (e) {
            ...
            var n = o(t.slice(1), 6), i = n[0], r = n[1], s = n[2], a = void 0 === s ? "" : s, l = n[3], c = n[4],
                u = void 0 === c ? "" : c, h = "", d = n[5], p = d.split("/");
        ...
        return function (e) {
            if (C) {
                var t = e.port, n = e.projectId, i = e.protocol;
    ...
    var L, M = ["fatal", "error", "warning", "log", "info", "debug", "critical"], I = u(), j = "Sentry Logger ",
    ...
    function W(e) {
        var t = e;
        if (p(e)) t = r({message: e.message, name: e.name, stack: e.stack}, Y(e)); else if (w(e)) {
            var n = e;
            t = r({
                type: n.type,
                target: K(n.target),
    ...
    function Q() {
        ...
        return function (e, t) {
            ...
            return function (e) {
                if (!e.length) return [];
                var t = e, n = t[0].function || "", i = t[t.length - 1].function || "";
        ...
        if (!ae[e]) switch (ae[e] = !0, e) {
            ...
            case"dom":
                !function () {
                    ...
                    var e = ue.bind(null, "dom"), t = ge(e, !0);
                        ...
                        n && n.hasOwnProperty && n.hasOwnProperty("addEventListener") && (F(n, "addEventListener", (function (t) {
                            ...
                            return function (t, n, i) {
                                if ("click" === t || "keypress" == t) try {
                                    var r = this, s = r.__sentry_instrumentation_handlers__ || {}, o = s[t];
            ...
            case"history":
                !function () {
                    if (!function () {
                        var e = u(), t = e.chrome, n = t && t.app && t.app.runtime,
                    ...
                    se.onpopstate = function () {
                        for (var t = [], n = 0; n < arguments.length; n++) t[n] = arguments[n];
                        var i = se.location.href, r = re;
                        if (re = i, ue("history", {from: r, to: i}), e) try {
                            return e.apply(this, t)
                        } catch (e) {
                        }
    ...
    function Te(e, t, n) {
        var i = e.exception = e.exception || {}, r = i.values = i.values || [], s = r[0] = r[0] || {};
    ...
    function Ae(e, t, n, i, r) {
        ...
        void 0 === n && (n = 1 / 0), void 0 === i && (i = 1 / 0), void 0 === r && (s = "function" == typeof WeakSet, a = s ? new WeakSet : [], r = [function (e) {
            ...
            if (s) a.delete(e); else for (var t = 0; t < a.length; t++) if (a[t] === e) {
                a.splice(t, 1);
                break
            }
        }]);
        var l, c = o(r, 2), u = c[0], h = c[1], d = t;
        ...
        var f = Array.isArray(t) ? [] : {}, g = 0, y = p(t) || w(t) ? W(t) : t;
    ...
    }, qe = je.nowSeconds.bind(je), $e = De.nowSeconds.bind(De);
    ...
    function Be(e) {
        var t = o(e, 2), n = t[0], i = t[1], r = JSON.stringify(n);
        return i.reduce((function (e, t) {
            var n = o(t, 2), i = n[0], r = n[1], s = v(r) ? String(r) : JSON.stringify(r);
            return e + "\n" + JSON.stringify(i) + "\n" + s
        }), r)
    }
    ...
    !function () {
        var e = u().performance;
        if (e && e.now) {
            var t = 36e5, n = e.now(), i = Date.now(), r = e.timeOrigin ? Math.abs(e.timeOrigin + n - i) : t, s = r < t,
                o = e.timing && e.timing.navigationStart, a = "number" == typeof o ? Math.abs(o + n - i) : t;
    ...
    function ze(e, t, n) {
        var i, o, a, l;
        void 0 === n && (n = Date.now());
        var c = r({}, e), u = t["x-sentry-rate-limits"], h = t["retry-after"];
        if (u) try {
            for (var d = s(u.trim().split(",")), p = d.next(); !p.done; p = d.next()) {
                var m = p.value.split(":", 2), f = parseInt(m[0], 10), g = 1e3 * (isNaN(f) ? 60 : f);
                if (m[1]) try {
    ...
    var Je = function () {
    ...
    }(), Xe = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__, Ge = 4, Qe = function () {
        function e(e, t, n) {
        ...
        return e.prototype.isOlderThan = function (e) {
            ...
            var n = this._lastEventId = t && t.event_id ? t.event_id : be(), i = t;
            if (!t) {
                var s = void 0;
                try {
            ...
            var i = this._lastEventId = n && n.event_id ? n.event_id : be(), s = n;
            if (!n) {
                var o = void 0;
                try {
                    throw new Error(e)
            ...
            if (i && s) {
                var o = s.getOptions && s.getOptions() || {}, a = o.beforeBreadcrumb, l = void 0 === a ? null : a,
                    c = o.maxBreadcrumbs, u = void 0 === c ? 100 : c;
                if (!(u <= 0)) {
                    var h = qe(), d = r({timestamp: h}, e), p = l ? D((function () {
                        return l(d, t)
                    })) : d;
            ...
            var t = this.getStackTop(), n = t.scope, i = t.client, s = i && i.getOptions() || {}, o = s.release,
                a = s.environment, l = (u().navigator || {}).userAgent,
            ...
            var r = this.getStackTop(), s = r.scope, o = r.client;
    ...
    function tt() {
        ...
        return nt(e) && !it(e).isOlderThan(Ge) || rt(e, new Qe), l() ? function (e) {
            try {
                var t = Ze().__SENTRY__, n = t && t.extensions && t.extensions.domain && t.extensions.domain.active;
                if (!n) return it(e);
    ...
    function ut(e) {
        return t = {sentry_key: e.publicKey, sentry_version: ot}, Object.keys(t).map((function (e) {
    ...
    var pt = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__, mt = [];
    ...
    function gt(e) {
        var t = {};
        return function (e) {
            var t = e.defaultIntegrations && a(e.defaultIntegrations) || [], n = e.integrations, i = a(ft(t));
    ...
    var yt = "Not capturing exception because it's already been captured.", vt = function () {
        function e(e, t) {
        ...
        return e.prototype.captureException = function (e, t, n) {
            ...
            this._isEnabled() ? "string" != typeof e.release ? pt && L.warn("Discarded session because of missing or non-string release") : (this._sendSession(e), e.update({init: !1})) : pt && L.warn("SDK not enabled, will not capture session.")
            ...
            var n, i, o = !1, a = !1, l = t.exception && t.exception.values;
            if (l) {
                a = !0;
                try {
            ...
            var i = this, s = this.getOptions(), o = s.normalizeDepth, a = void 0 === o ? 3 : o,
                l = s.normalizeMaxBreadth, c = void 0 === l ? 1e3 : l, u = r(r({}, e), {
            ...
            }), e.user && {user: xe(e.user, t, n)}), e.contexts && {contexts: xe(e.contexts, t, n)}), e.extra && {extra: xe(e.extra, t, n)});
            ...
            var t = this.getOptions(), n = t.environment, i = t.release, r = t.dist, s = t.maxValueLength,
                o = void 0 === s ? 250 : s;
            ...
            var i = this, r = this.getOptions(), s = r.beforeSend, o = r.sampleRate, a = this.getTransport();
    ...
    function _t(e, t) {
        var n = bt(t), i = "aggregates" in e ? "sessions" : "session";
    ...
    var kt = function () {
        ...
        return e.prototype.eventFromException = function (e, t) {
            ...
            if (this._newTransport && this._options.dsn && this._options._experiments && this._options._experiments.newTransport) {
                var t = function (e, t) {
                    var n = bt(t), i = e.type || "event", s = (e.sdkProcessingMetadata || {}).transactionSampling || {},
                        o = s.method, a = s.rate;
                    ...
                    }, n && {sdk: n}), !!t.tunnel && {dsn: P(t.dsn)}), [[{
                        type: i,
                        sample_rates: [{id: o, rate: a}]
                    }, e]])
    ...
    function St(e, t, n) {
        ...
        return {
            send: function (e) {
                var r = function (e) {
                    var t = o(e, 2), n = o(t[1], 1);
                    return o(n[0], 1)[0].type
                }(e), s = "event" === r ? "error" : r, a = {category: s, body: Be(e)};
                return Ve(i, s) ? Oe({status: "rate_limit", reason: xt(i, s)}) : n.add((function () {
                    return t(a).then((function (e) {
                        var t = e.body, n = e.headers, r = e.reason, o = Ie(e.statusCode);
                        return n && (i = ze(i, n)), "success" === o ? Pe({status: o, reason: r}) : Oe({
                            status: o,
    ...
    }(), Ot = [/^Script error\.?$/, /^Javascript error: Script error\.? on line 0$/], Nt = function () {
        function e(t) {
        ...
        return e.prototype.setupOnce = function (t, n) {
            t((function (t) {
                ...
                if (i) {
                    ...
                    if (r) {
                        var s = i.getClient(), o = s ? s.getOptions() : {}, l = function (e, t) {
                            void 0 === e && (e = {});
                            void 0 === t && (t = {});
                            return {
                        ...
                        return function (e, t) {
                            ...
                            if (function (e, t) {
                                ...
                                return function (e) {
                                    ...
                                    if (e.exception) try {
                                        var t = e.exception.values && e.exception.values[0] || {}, n = t.type,
                                            i = void 0 === n ? "" : n, r = t.value, s = void 0 === r ? "" : r;
                                        return ["" + s, i + ": " + s]
                                    } catch (t) {
    ...
    var Rt = /^\s*at (?:(.*?) ?\((?:address at )?)?((?:file|https?|blob|chrome-extension|address|native|eval|webpack|<anonymous>|[-a-z]+:|.*bundle|\/).*?)(?::(\d+))?(?::(\d+))?\)?\s*$/i,
        ...
        Ut = /(\S+) line (\d+)(?: > eval line \d+)* > eval/i, Bt = [50, function (e) {
            var t, n = $t.exec(e);
            if (n) {
        ...
        }], Vt = / line (\d+).*script (?:in )?(\S+)(?:: in function (\S+))?$/i, zt = [10, function (e) {
            var t = Vt.exec(e);
        ...
        Kt = [20, function (e) {
            ...
            var n = -1 !== e.indexOf("safari-extension"), i = -1 !== e.indexOf("safari-web-extension");
            return n || i ? [-1 !== e.indexOf("@") ? e.split("@")[0] : It, n ? "safari-extension:" + t : "safari-web-extension:" + t] : [e, t]
        };

    function Jt(e) {
        var t = Gt(e), n = {type: e && e.name, value: Zt(e)};
    ...
    function en(e, t, n, i) {
        ...
        if (g(e) || m(e, "DOMException")) {
            var o = e;
            if ("stack" in e) s = Xt(e); else {
                var a = o.name || (g(o) ? "DOMError" : "DOMException"), l = o.message ? a + ": " + o.message : a;
                Te(s = tn(l, t, n), l)
            }
        ...
        return p(e) ? Xt(e) : b(e) || w(e) ? (s = function (e, t, n) {
            ...
            return i
        }(e, t, i), Ee(s, {synthetic: !0}), s) : (Te(s = tn(e, t, n), "" + e, void 0), Ee(s, {synthetic: !0}), s)
    }
    ...
    var nn, rn = "undefined" == typeof __SENTRY_DEBUG__ || __SENTRY_DEBUG__, sn = u();
    ...
    var cn = u(), un = function () {
        ...
        return e.prototype.sendEvent = function (e) {
            return this._sendRequest(function (e, t) {
                var n, i = bt(t), s = e.type || "event", o = "transaction" === s || !!t.tunnel,
                    a = (e.sdkProcessingMetadata || {}).transactionSampling || {}, l = a.method, c = a.rate;
                ...
                if (o) {
                    var d = Ue(r(r({
                        event_id: e.event_id,
                        sent_at: (new Date).toISOString()
                    }, i && {sdk: i}), !!t.tunnel && {dsn: P(t.dsn)}), [[{
                        type: s,
                        sample_rates: [{id: l, rate: c}]
                    }, h.body]]);
                    h.body = Be(d)
                }
                return h
            ...
            if (this.options.sendClientReports) {
                ...
                if (this._outcomes = {}, Object.keys(e).length) {
                    ...
                    var t, n, i, r = dt(this._api.dsn, this._api.tunnel), s = Object.keys(e).map((function (t) {
                            var n = o(t.split(":"), 2), i = n[0];
                            return {reason: n[1], category: i, quantity: e[t]}
                        })),
                        a = (t = s, Ue((n = this._api.tunnel && P(this._api.dsn)) ? {dsn: n} : {}, [[{type: "client_report"}, {
                            timestamp: i || qe(),
                            discarded_events: t
                        }]]));
                    try {
            ...
            var t = e.requestType, n = e.response, i = e.headers, r = e.resolve, s = e.reject, o = Ie(n.status);
    ...
    var mn = function (e) {
        ...
        return n(t, e), t.prototype.eventFromException = function (e, t) {
            ...
            return void 0 === t && (t = i.Info), function (e, t, n, r) {
                void 0 === t && (t = i.Info);
            ...
            }), s = at(i.dsn, i._metadata, i.tunnel), o = dt(s.dsn, s.tunnel);
            ...
            if (te()) {
                ...
                return this._newTransport = (t = {
                    requestOptions: a,
                    url: o
                }, void 0 === n && (n = on()), St({bufferSize: t.bufferSize}, (function (e) {
            ...
            }({url: o, headers: i.headers}), new dn(i)
        }, t
    }(Tt), fn = u(), gn = 0;
    ...
    function bn(e) {
        if (void 0 === e && (e = {}), fn.document) if (e.eventId) if (e.dsn) {
            var t = fn.document.createElement("script");
            t.async = !0, t.src = function (e, t) {
                var n = N(e), i = lt(n) + "embed/error-page/", r = "dsn=" + P(n);
                for (var s in t) if ("dsn" !== s) if ("user" === s) {
                    if (!t.user) continue;
            ...
            n && n.appendChild(t)
        } else rn && L.error("Missing dsn option in showReportDialog call"); else rn && L.error("Missing eventId option in showReportDialog call")
    }
    ...
    function _n() {
        ce("error", (function (e) {
            var t = o(Sn(), 2), n = t[0], r = t[1];
            if (n.getIntegration(wn)) {
                var s = e.msg, a = e.url, l = e.line, c = e.column, u = e.error;
                if (!(yn() || u && u.__sentry_own_request__)) {
                    var h = void 0 === u && y(s) ? function (e, t, n, i) {
                        var r = /^(?:[Uu]ncaught (?:exception: )?)?(?:((?:Eval|Internal|Range|Reference|Syntax|Type|URI|)Error): )?(.*)$/i,
                            s = f(e) ? e.message : e, o = "Error", a = s.match(r);
                        a && (o = a[1], s = a[2]);
    ...
    function Tn(e, t, n, i) {
        var r = e.exception = e.exception || {}, s = r.values = r.values || [], o = s[0] = s[0] || {},
            a = o.stacktrace = o.stacktrace || {}, l = a.frames = a.frames || [],
            c = isNaN(parseInt(i, 10)) ? void 0 : i, h = isNaN(parseInt(n, 10)) ? void 0 : n,
    ...
    function Pn(e) {
        return function (t) {
            return e.apply(this, [vn(t, {
                mechanism: {
                    data: {function: "requestAnimationFrame", handler: ee(e)},
                    handled: !0,
                    type: "instrument"
                }
            })])
        ...
        return e.prototype.addSentryBreadcrumb = function (e) {
            ...
            this._options.console && ce("console", Mn), this._options.dom && ce("dom", function (e) {
                function t(t) {
                    ...
                    0 !== n.length && tt().addBreadcrumb({category: "ui." + t.name, message: n}, {
                        event: t.event,
                        name: t.name,
                        global: t.global
                    })
    ...
    function In(e) {
        if (e.endTimestamp) {
            ...
            var t = e.xhr.__sentry_xhr__ || {}, n = t.method, i = t.url, r = t.status_code, s = t.body;
            tt().addBreadcrumb({category: "xhr", data: {method: n, url: i, status_code: r}, type: "http"}, {
                xhr: e.xhr,
                input: s
            })
        } else ;
    ...
    function jn(e) {
        e.endTimestamp && (e.fetchData.url.match(/sentry_key/) && "POST" === e.fetchData.method || (e.error ? tt().addBreadcrumb({
            ...
            level: i.Error,
            type: "http"
        }, {data: e.error, input: e.args}) : tt().addBreadcrumb({
            category: "fetch",
    ...
    function Rn(e) {
        var t = u(), n = e.from, i = e.to, r = we(t.location.href), s = we(n), o = we(i);
            ...
            Ye((function (t) {
                if (tt().getIntegration(e)) {
                    ...
                    var n = t.request && t.request.url || Bn.location && Bn.location.href,
                        i = (Bn.document || {}).referrer, s = (Bn.navigator || {}).userAgent,
    ...
    function zn(e, t) {
        var n = e.fingerprint, i = t.fingerprint;
        if (!n && !i) return !0;
        if (n && !i || !n && i) return !1;
        try {
    ...
    var Yn = function (e) {
        function t(t) {
            ...
            return t._metadata = t._metadata || {}, t._metadata.sdk = t._metadata.sdk || {
                ...
                packages: [{name: "npm:@sentry/browser", version: At}],
                version: At
    ...
    }(vt), Jn = [new Nt, new Pt, new Cn, new Ln, new wn, new $n, new Hn, new Fn];
    ...
    function Xn(e) {
        ...
        void 0 === e.autoSessionTracking && (e.autoSessionTracking = !0), void 0 === e.sendClientReports && (e.sendClientReports = !0), function (e, t) {
            !0 === t.debug && (pt ? L.enable() : console.warn("[Sentry] Cannot initialize SDK with `debug` option using a non-debug bundle."));
            var n = tt(), i = n.getScope();
    ...
    var ii = function (e) {
        ...
        nullOrUndefined: si, object: oi, number: function (e) {
            return ii(e) === Number && !Number.isNaN(e)
        }, string: ai, boolean: function (e) {
            return ii(e) === Boolean
        }, function: function (e) {
            return ii(e) === Function
        }, array: li, nodeList: ci, element: function (e) {
            return ri(e, Element)
        }, event: function (e) {
            return ri(e, Event)
        }, empty: function (e) {
        ...
        facebook: {
            domain: "facebook.com", url: function (e) {
    ...
    var vi = function () {
        function e(t, n) {
            ...
            Qn(this, e), this.elements = {
                ...
                trigger: null,
                popup: null
            }, ui.element(t) ? this.elements.trigger = t : ui.string(t) && (this.elements.trigger = document.querySelector(t)), ui.element(this.elements.trigger) && ui.empty(this.elements.trigger.shr) && (this.config = gi({}, di, n, {networks: hi}), this.console = new mi(this.config.debug), this.storage = new yi(this.config.storage.key, this.config.storage.ttl, this.config.storage.enabled), this.getCount().then((function (e) {
                return i.updateDisplay(e)
            })).catch((function () {
            })), this.listeners(!0), this.elements.trigger.shr = this)
        }
        ...
        return ei(e, [{
            ...
            key: "openPopup", value: function (e) {
                if (!ui.empty(this.network) && this.networkConfig.popup) {
                    ...
                    var t = this.networkConfig.popup, n = t.width, i = t.height, r = "shr-popup--".concat(this.network);
                    if (this.popup && !this.popup.closed) this.popup.focus(), this.console.log("Popup re-focused."); else {
                        var s = void 0 === window.screenLeft ? window.screen.left : window.screenLeft,
                            ...
                            a = window.screen.width / 2 - n / 2 + s, l = window.screen.height / 2 - i / 2 + o;
            ...
            key: "getCount", value: function () {
                ...
                return new Promise((function (n, i) {
                    var r = e.apiUrl;
                    if (ui.empty(r)) i(new Error("No URL available for ".concat(e.network, "."))); else {
                        if (t) {
                        ...
                        (function (e) {
                            ...
                            var i = 0, r = e.elements.trigger.getAttribute("data-shr-display");
            ...
            key: "updateDisplay", value: function (e) {
                var t = !!(1 < arguments.length && void 0 !== arguments[1]) && arguments[1], n = this.config,
                    i = n.count, r = n.wrapper, s = t ? e + 1 : e, o = i.position.toLowerCase();
                if (0 < s || i.displayZero) {
                    ...
                    i.format && (1e6 < s ? l = "".concat(a(1e6), "M") : 1e3 < s && (l = "".concat(a(1e3), "K"))), ui.element(this.elements.count) ? this.elements.count.textContent = l : (function (e, t) {
                        ...
                        Array.from(n).reverse().forEach((function (e, n) {
                            var i = 0 < n ? t.cloneNode(!0) : t, r = e.parentNode, s = e.nextSibling;
                            i.appendChild(e), s ? r.insertBefore(i, s) : r.appendChild(i)
                        }))
                    }(this.elements.trigger, fi("span", {class: r.className})), this.elements.count = fi("span", {class: "".concat(i.className, " ").concat(i.className, "--").concat(o)}, l), this.elements.trigger.insertAdjacentElement("after" === o ? "afterend" : "beforebegin", this.elements.count))
                }
            }
        }, {
            ...
            key: "network", get: function () {
                ...
                return Object.keys(t).find((function (n) {
                    return function (e) {
                        var t = new URL(e).hostname, n = t.split("."), i = n.length;
            ...
            key: "setup", value: function (t) {
                ...
                })).observe(document.body, {childList: !0, subtree: !0}), i.map((function (t) {
                    return new e(t, n)
                }))
            }
        }]), e
    ...
    var Si = function (e) {
        ...
        nullOrUndefined: Ci, object: Ai, number: function (e) {
            return Si(e) === Number && !Number.isNaN(e)
        }, string: Pi, boolean: function (e) {
            return Si(e) === Boolean
        }, function: function (e) {
            return Si(e) === Function
        }, array: Oi, nodeList: Ni, element: function (e) {
            return xi(e, Element)
        }, event: function (e) {
            return xi(e, Event)
        }, empty: function (e) {
    ...
    var Ii = function () {
        ...
        return function (e, t, n) {
            ...
            key: "get", value: function (t) {
                ...
                var n, i = t.target, r = t.changedTouches[0], s = parseFloat(i.getAttribute("min")) || 0,
                    o = parseFloat(i.getAttribute("max")) || 100, a = parseFloat(i.getAttribute("step")) || 1,
                    l = i.getBoundingClientRect(), c = 100 / l.width * (this.config.thumbWidth / 2) / 100;
    ...
    const ji = e => null != e ? e.constructor : null, Ri = (e, t) => Boolean(e && t && e instanceof t),
        Di = e => null == e, qi = e => ji(e) === Object, $i = e => ji(e) === String, Ui = e => "function" == typeof e,
        Bi = e => Array.isArray(e), Fi = e => Ri(e, NodeList),
    ...
    function Xi(e, t) {
        ...
        Array.from(n).reverse().forEach(((e, n) => {
            const i = n > 0 ? t.cloneNode(!0) : t, r = e.parentNode, s = e.nextSibling;
            i.appendChild(e), s ? r.insertBefore(i, s) : r.appendChild(i)
        }))
    }
    ...
    function ir(e, t) {
        ...
        return e.split(",").forEach((e => {
            const t = e.trim(), r = t.replace(".", ""), s = t.replace(/[[\]]/g, "").split("="), [o] = s,
    ...
    function mr(e, t, n, i = !1, r = !0, s = !1) {
        ...
        const o = t.split(" ");
        let a = s;
        pr && (a = {passive: r, capture: s}), o.forEach((t => {
    ...
    const Sr = [[1, 1], [4, 3], [3, 4], [5, 4], [4, 5], [3, 2], [2, 3], [16, 10], [10, 16], [16, 9], [9, 16], [21, 9], [9, 21], [32, 9], [9, 32]].reduce(((e, [t, n]) => ({
        ...e,
        [t / n]: [t, n]
    })), {});
    ...
    function Pr(e) {
        ...
        const {wrapper: t} = this.elements, n = Ar.call(this, e);
    ...
    function Or(e, t, n = .05) {
        const i = e / t, r = Tr(Object.keys(Sr), i);
        ...
        getSources() {
            ...
            e.options.speed = e.config.speed.options, Vi.empty(this.config.ratio) || Pr.call(e), Object.defineProperty(e.media, "quality", {
                get() {
                    ...
                    if (e.quality !== t) {
                        if (e.config.quality.forced && Vi.function(e.config.quality.onChange)) e.config.quality.onChange(t); else {
    ...
    const Dr = {pip: "PIP", airplay: "AirPlay", html5: "HTML5", vimeo: "Vimeo", youtube: "YouTube"}, qr = {
        get(e = "", t = {}) {
    ...
    function Br(e, t) {
        ...
        const n = "cache", i = Vi.string(t);
        let r = !1;
        const s = () => null !== document.getElementById(t), o = (e, t) => {
            e.innerHTML = t, i && s() || document.body.insertAdjacentElement("afterbegin", e)
        };
        if (!i || !s()) {
            const s = $r.supported, a = document.createElement("div");
    ...
    const Fr = e => Math.trunc(e / 60 / 60 % 60, 10), Hr = e => Math.trunc(e / 60 % 60, 10),
    ...
    const Wr = {
        getIconUrl() {
            ...
            const n = "http://www.w3.org/2000/svg", i = Wr.getIconUrl.call(this),
                r = `${i.cors ? "" : i.url}#${this.config.iconPrefix}`, s = document.createElementNS(n, "svg");
            Gi(s, Ji(t, {"aria-hidden": "true", focusable: "false"}));
            const o = document.createElementNS(n, "use"), a = `${r}-${e}`;
            ...
            })), "button" !== r.element || Object.keys(n).includes("type") || (n.type = "button"), Object.keys(n).includes("class") ? n.class.split(" ").some((e => e === this.config.classNames.control)) || Ji(n, {class: `${n.class} ${this.config.classNames.control}`}) : n.class = this.config.classNames.control, e) {
                case"play":
            ...
            return r.toggle ? (s.appendChild(Wr.createIcon.call(this, r.iconPressed, {class: "icon--pressed"})), s.appendChild(Wr.createIcon.call(this, r.icon, {class: "icon--not-pressed"})), s.appendChild(Wr.createLabel.call(this, r.labelPressed, {class: "label--pressed"})), s.appendChild(Wr.createLabel.call(this, r.label, {class: "label--not-pressed"}))) : (s.appendChild(Wr.createIcon.call(this, r.icon)), s.appendChild(Wr.createLabel.call(this, r.label))), Ji(n, ir(this.config.selectors.buttons[i], n)), Gi(s, n), "play" === i ? (Vi.array(this.elements.buttons[i]) || (this.elements.buttons[i] = []), this.elements.buttons[i].push(s)) : this.elements.buttons[i] = s, s
        }, createRange(e, t) {
            ...
            if ("volume" !== e) {
                ...
                const t = {played: "played", buffer: "buffered"}[e], i = t ? qr.get(t, this.config) : "";
                n.innerText = `% ${i.toLowerCase()}`
            }
            return this.elements.display[e] = n, n
        }, createTime(e, t) {
            const n = ir(this.config.selectors.display[e], t), i = Qi("div", Ji(n, {
            ...
            fr.call(this, e, "keydown keyup", (n => {
                ...
                if (!i && [" ", "ArrowRight"].includes(n.key)) Wr.showMenuPanel.call(this, t, !0); else {
                    let t;
            ...
            const o = ir(this.config.selectors.inputs[n]), a = Qi("button", Ji(o, {
                type: "button",
                role: "menuitemradio",
            ...
            let t = 0;
            const n = (e, t) => {
                const n = Vi.number(t) ? t : 0, i = Vi.element(e) ? e : this.elements.display.buffer;
                if (Vi.element(i)) {
                    i.value = n;
            ...
            if (Vi.element(t) && "range" === t.getAttribute("type")) {
                if (ar(t, this.config.selectors.inputs.seek)) {
                    ...
                    const e = Wr.formatTime(this.currentTime), n = Wr.formatTime(this.duration),
            ...
            const i = this.elements.display.seekTooltip, r = `${this.config.classNames.tooltip}--visible`,
                s = e => sr(i, r, e);
            if (this.touch) return void s(!1);
            let o = 0;
            const a = this.elements.progress.getBoundingClientRect();
            if (Vi.event(e)) o = 100 / a.width * (e.pageX - a.left); else {
                if (!or(i, r)) return;
            ...
            const e = "captions", t = this.elements.settings.panels.captions.querySelector('[role="menu"]'),
                n = Jr.getTracks.call(this), i = Boolean(n.length);
            ...
            const {buttons: e} = this.elements.settings, t = !Vi.empty(e) && Object.values(e).some((e => !e.hidden));
            ...
            const {hidden: i} = t;
            let r = i;
            if (Vi.boolean(e)) r = e; else if (Vi.keyboardEvent(e) && "Escape" === e.key) r = !1; else if (Vi.event(e)) {
                const i = Vi.function(e.composedPath) ? e.composedPath()[0] : e.target, s = t.contains(i);
            ...
            const i = n.parentNode, r = Array.from(i.children).find((e => !e.hidden));
            if (dr.transitions && !dr.reducedMotion) {
                i.style.width = `${r.scrollWidth}px`, i.style.height = `${r.scrollHeight}px`;
                const e = Wr.getMenuSize.call(this, n), t = e => {
            ...
            return kr(Vi.array(this.config.controls) ? this.config.controls : []).forEach((o => {
                ...
                if ("current-time" === o && c.appendChild(s.call(this, "currentTime", u)), "duration" === o && c.appendChild(s.call(this, "duration", u)), "mute" === o || "volume" === o) {
                    ...
                    if (Vi.element(t) && c.contains(t) || (t = Qi("div", Ji({}, u, {class: `${u.class} plyr__volume`.trim()})), this.elements.volume = t, c.appendChild(t)), "mute" === o && t.appendChild(n.call(this, "mute")), "volume" === o && !Ki.isIos && !Ki.isIPadOS) {
                ...
                if ("captions" === o && c.appendChild(n.call(this, "captions", u)), "settings" === o && !Vi.empty(this.config.settings)) {
                    ...
                    const r = Qi("div", {class: "plyr__menu__container", id: `plyr-settings-${e.id}`, hidden: ""}),
                        s = Qi("div"), o = Qi("div", {id: `plyr-settings-${e.id}-home`}), a = Qi("div", {role: "menu"});
                    o.appendChild(a), s.appendChild(o), this.elements.settings.panels.home = o, this.config.settings.forEach((n => {
                        ...
                        const c = Qi("div", {id: `plyr-settings-${e.id}-${n}`, hidden: ""}), u = Qi("button", {
                            type: "button",
                            class: `${this.config.classNames.control} ${this.config.classNames.control}--back`
                        });
                        u.appendChild(Qi("span", {"aria-hidden": !0}, qr.get(n, this.config))), u.appendChild(Qi("span", {class: this.config.classNames.hidden}, qr.get("menuBack", this.config))), fr.call(this, c, "keydown", (e => {
                            "ArrowLeft" === e.key && (e.preventDefault(), e.stopPropagation(), l.call(this, "home", !0))
                        }), !1), fr.call(this, u, "click", (() => {
                            l.call(this, "home", !1)
                        })), c.appendChild(u), c.appendChild(Qi("div", {role: "menu"})), s.appendChild(c), this.elements.settings.buttons[n] = i, this.elements.settings.panels[n] = c
            ...
            if (Ki.isEdge && Wi(i), this.config.tooltips.controls) {
                const {classNames: e, selectors: t} = this.config, n = `${t.controls.wrapper} ${t.labels} .${e.hidden}`,
                    i = lr.call(this, n);
            ...
            const i = document.createDocumentFragment(), r = document.createDocumentFragment();
            let s = null;
            const o = `${this.config.classNames.tooltip}--visible`, a = e => sr(s, o, e);
            n.forEach((e => {
            ...
            })), i.appendChild(r), this.config.tooltips.seek || (s = Qi("span", {class: this.config.classNames.tooltip}, ""), i.appendChild(s)), this.elements.markers = {
                points: r,
                tip: s
    ...
    const Jr = {
            setup() {
                ...
                if (Vi.element(this.elements.captions) || (this.elements.captions = Qi("div", ir(this.config.selectors.captions)), this.elements.captions.setAttribute("dir", "auto"), e = this.elements.captions, t = this.elements.wrapper, Vi.element(e) && Vi.element(t) && t.parentNode.insertBefore(e, t.nextSibling)), Ki.isIE && window.URL) {
                    ...
                    Array.from(e).forEach((e => {
                        const t = e.getAttribute("src"), n = Kr(t);
                ...
                if (Vi.boolean(r) || ({active: r} = this.config.captions), Object.assign(this.captions, {
                    toggled: !1,
                    active: r,
                    language: i,
                    languages: n
                ...
                const e = Jr.getTracks.call(this, !0), {
                    ...
                    meta: i,
                    currentTrackNode: r
                } = this.captions, s = Boolean(e.find((e => e.language === n)));
                ...
                if (-1 !== e) if (Vi.number(e)) if (e in n) {
                    if (this.captions.currentTrack !== e) {
                        this.captions.currentTrack = e;
                        const i = n[e], {language: r} = i || {};
                        this.captions.currentTrackNode = i, Wr.updateSetting.call(this, "captions"), t || (this.captions.language = r, this.storage.set({language: r})), this.isVimeo && this.embed.enableTextTrack(r), vr.call(this, this.media, "languagechange")
                    }
                    Jr.toggle.call(this, !0, t), this.isHTML5 && this.isVideo && Jr.updateCues.call(this)
                } else this.debug.warn("Track not found", e); else this.debug.warn("Invalid caption argument", e); else Jr.toggle.call(this, !1, t)
            }, setLanguage(e, t = !0) {
                if (!Vi.string(e)) return void this.debug.warn("Invalid language argument", e);
                const n = e.toLowerCase();
                this.captions.language = n;
                const i = Jr.getTracks.call(this), r = Jr.findTrack.call(this, [n]);
                ...
                const n = Jr.getTracks.call(this), i = e => Number((this.captions.meta.get(e) || {}).default),
        ...
        }, Gr = "picture-in-picture", Qr = "inline", Zr = {html5: "html5", youtube: "youtube", vimeo: "vimeo"},
        es = "audio", ts = "video";
    const ns = () => {
    };
        ...
        constructor(e) {
            bi(this, "onChange", (() => {
                ...
                const t = document.activeElement,
                    n = lr.call(this.player, "a[href], button:not(:disabled), input:not(:disabled), [tabindex]"), [i] = n,
                    r = n[n.length - 1];
                ...
                this.supported && (Ki.isIos && this.player.config.fullscreen.iosNative ? this.player.isVimeo ? this.player.embed.requestFullscreen() : this.target.webkitEnterFullscreen() : !rs.nativeSupported || this.forceFallback ? this.toggleFallback(!0) : this.prefix ? Vi.empty(this.prefix) || this.target[`${this.prefix}Request${this.property}`]() : this.target.requestFullscreen({navigationUI: "hide"}))
            })), bi(this, "exit", (() => {
                if (this.supported) if (Ki.isIos && this.player.config.fullscreen.iosNative) this.player.isVimeo ? this.player.embed.exitFullscreen() : this.target.webkitEnterFullscreen(), _r(this.player.play()); else if (!rs.nativeSupported || this.forceFallback) this.toggleFallback(!1); else if (this.prefix) {
    ...
    const os = {
        addStyleHook() {
            ...
            }), 0), os.setTitle.call(this), this.poster && os.setPoster.call(this, this.poster, !1).catch((() => {
            })), this.config.duration && Wr.durationUpdate.call(this), this.config.mediaMetadata && Wr.setMediaMetadata.call(this)
        }, setTitle() {
            ...
            Object.values({...this.media.style}).filter((e => !Vi.empty(e) && Vi.string(e) && e.startsWith("--plyr"))).forEach((e => {
    ...
    class as {
        constructor(e) {
            bi(this, "firstTouch", (() => {
                ...
                const r = () => {
                    ...
                    const t = n.wrapper, {active: i} = e.fullscreen, [r, s] = Ar.call(e),
                ...
                const {player: i} = this, r = i.config.listeners[n];
                let s = !0;
                Vi.function(r) && (s = r.call(i, e)), !1 !== s && Vi.function(t) && t.call(i, e)
            })), bi(this, "bind", ((e, t, n, i, r = !0) => {
                const {player: s} = this, o = s.config.listeners[i], a = Vi.function(o);
                fr.call(s, e, t, (e => this.proxy(e, n, i)), r && !a)
            })), bi(this, "controls", (() => {
                const {player: e} = this, {elements: t} = e, n = Ki.isIE ? "change" : "input";
                if (t.buttons.play && Array.from(t.buttons.play).forEach((t => {
                    ...
                    const n = t.currentTarget, i = "play-on-seeked";
                    if (Vi.keyboardEvent(t) && !["ArrowLeft", "ArrowRight"].includes(t.key)) return;
                    e.lastSeekTime = Date.now();
                    const r = n.hasAttribute(i), s = ["mouseup", "touchend", "keyup"].includes(t.type);
                ...
                this.bind(t.inputs.seek, n, (t => {
                    ...
                    const n = t.webkitDirectionInvertedFromDevice, [i, r] = [t.deltaX, -t.deltaY].map((e => n ? -e : e)),
        ...
        handleKey(e) {
            ...
            if (c) {
                ...
                if (Vi.element(r)) {
                    const {editable: i} = t.config.selectors, {seek: s} = n.inputs;
    ...
    var ls = function (e, t) {
        ...
        e.exports = function () {
            ...
            function a(t, n, i, r) {
                var s, o, l = document, c = i.async, u = (i.numRetries || 0) + 1, h = i.before || e,
            ...
            function l(e, t, n) {
                var i, r, s = (e = e.push ? e : [e]).length, o = s, l = [];
    ...
    const hs = {
        setup() {
            ...
            const e = this, t = e.config.vimeo, {premium: n, referrerPolicy: i, ...r} = t;
            let s = e.media.getAttribute("src"), o = "";
            ...
            const l = Yr({
                    ...
                    muted: e.muted,
                    gesture: "media",
                    playsinline: e.config.playsinline, ...a, ...r
                }),
                c = (u = s, Vi.empty(u) ? null : Vi.number(Number(u)) ? u : u.match(/^.*(vimeo.com\/|video\/)(\d+).*/) ? RegExp.$2 : u);
            var u;
            const h = Qi("iframe"), d = Lr(e.config.urls.vimeo.iframe, c, l);
            if (h.setAttribute("src", d), h.setAttribute("allowfullscreen", ""), h.setAttribute("allow", ["autoplay", "fullscreen", "picture-in-picture", "encrypted-media", "accelerometer", "gyroscope"].join("; ")), Vi.empty(i) || h.setAttribute("referrerPolicy", i), n || !t.customControls) h.setAttribute("data-poster", e.poster), e.media = nr(h, e.media); else {
            ...
            Object.defineProperty(e.media, "currentTime", {
                get: () => p, set(t) {
                    const {embed: n, media: i, paused: r, volume: s} = e, o = r && !n.hasPlayed;
    ...
    const ms = {
        setup() {
            if (sr(this.elements.wrapper, this.config.classNames.embed, !0), Vi.object(window.YT) && Vi.function(window.YT.Player)) ms.ready.call(this); else {
    ...
    class gs {
        constructor(e) {
            bi(this, "load", (() => {
                ...
                this.elements.container = Qi("div", {class: this.player.config.classNames.ads}), this.player.elements.container.appendChild(this.elements.container), google.ima.settings.setVpaidMode(google.ima.ImaSdkSettings.VpaidMode.ENABLED), google.ima.settings.setLocale(this.player.config.ads.language), google.ima.settings.setDisableCustomPlaybackForIOS10Plus(this.player.config.playsinline), this.elements.displayContainer = new google.ima.AdDisplayContainer(this.elements.container, this.player.media), this.loader = new google.ima.AdsLoader(this.elements.displayContainer), this.loader.addEventListener(google.ima.AdsManagerLoadedEvent.Type.ADS_MANAGER_LOADED, (e => this.onAdsManagerLoaded(e)), !1), this.loader.addEventListener(google.ima.AdErrorEvent.Type.AD_ERROR, (e => this.onAdError(e)), !1), this.requestAds()
            })), bi(this, "requestAds", (() => {
    ...
    class ws {
        constructor(e) {
            bi(this, "load", (() => {
                ...
                this.elements.thumb.container = Qi("div", {class: this.player.config.classNames.previewThumbnails.thumbContainer}), this.elements.thumb.imageContainer = Qi("div", {class: this.player.config.classNames.previewThumbnails.imageContainer}), this.elements.thumb.container.appendChild(this.elements.thumb.imageContainer);
                const e = Qi("div", {class: this.player.config.classNames.previewThumbnails.timeContainer});
                this.elements.thumb.time = Qi("span", {}, "00:00"), e.appendChild(this.elements.thumb.time), this.elements.thumb.imageContainer.appendChild(e), Vi.element(this.player.elements.progress) && this.player.elements.progress.appendChild(this.elements.thumb.container), this.elements.scrubbing.container = Qi("div", {class: this.player.config.classNames.previewThumbnails.scrubbingContainer}), this.player.elements.wrapper.appendChild(this.elements.scrubbing.container)
            })), bi(this, "destroy", (() => {
                ...
                const t = this.showingThumb, n = this.thumbnails[e], {urlPrefix: i} = n, r = n.frames[t],
                    s = n.frames[t].text, o = i + s;
                if (this.currentImageElement && this.currentImageElement.dataset.filename === s) this.showImage(this.currentImageElement, r, e, t, s, !1), this.currentImageElement.dataset.index = t, this.removeOldImages(this.currentImageElement); else {
                    ...
                    if (this.showingThumbFilename === i) {
                        ...
                        r.forEach((e => {
                            ...
                            if (t !== i && !this.loadedImages.includes(t)) {
                                ...
                                const {urlPrefix: e} = this.thumbnails[0], i = e + t, r = new Image;
                                r.src = i, r.onload = () => {
                ...
                const e = this.player.elements.progress.getBoundingClientRect(),
                    ...
                    i = t.left - e.left + 10, r = t.right - e.left - n.clientWidth - 10,
                    s = this.mousePosX - e.left - n.clientWidth / 2, o = ys(s, i, r);
    ...
    const _s = {
        insertElements(e, t) {
            Vi.string(t) ? Zi(e, this.media, {src: t}) : Vi.array(t) && t.forEach((t => {
                Zi(e, this.media, t)
            }))
        }, change(e) {
            Yi(e, "sources.length") ? (Nr.cancelRequests.call(this), this.destroy.call(this, (() => {
                ...
                const {sources: t, type: n} = e, [{provider: i = Zr.html5, src: r}] = t, s = "html5" === i ? n : "div",
                    o = "html5" === i ? {} : {src: r};
                Object.assign(this, {
                    provider: i,
                    type: n,
    ...
    class ks {
        ...
        set volume(e) {
            let t = e;
            Vi.string(t) && (t = Number(t)), Vi.number(t) || (t = this.storage.get("volume")), Vi.number(t) || ({volume: t} = this.config), t > 1 && (t = 1), t < 0 && (t = 0), this.config.volume = t, this.media.volume = t, !Vi.empty(e) && this.muted && t > 0 && (this.muted = !1)
        }
        ...
        set poster(e) {
            this.isVideo ? os.setPoster.call(this, e, !1).catch((() => {
    ...
    const Es = {
        ...
        // },
        // youtube: {type: "video", sources: [{src: "https://youtube.com/watch?v=bTqVqk7FSmY", provider: "youtube"}]},
        // vimeo: {type: "video", sources: [{src: "https://vimeo.com/40648169", provider: "vimeo"}]}
    };
    (() => {
        const e = "plyr.io";
        window.location.host.includes(e) && Xn({
            ...
            const e = new ks("#player", {
                ...
                markers: {
                    enabled: !0,
                    points: [{time: 10, label: "first marker"}, {time: 40, label: "second marker"}, {
                        time: 120,
            ...
            window.player = e;
            const t = document.querySelectorAll("[data-source]"), n = Object.keys(Es),
            ...
            })), s || (r = "video"), i && n.includes(r) && window.history.replaceState({type: r}, "", s ? `#${r}` : ""), "video" !== r && a(r, !0), o(r)
        }))
    })()
}();
